			...
			<div class="modal-body">
				...
				<form action="{{ asset('admin/user/tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" name="job_desk" class="form-control" placeholder="Job Desk" value="{{ old('job_desk') }}" required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" name="instagram" class="form-control" placeholder="Instagram" value="{{ old('instagram') }}" required>
						</div>
					</div>			
